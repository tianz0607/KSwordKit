...
namespace KSwordKit.Contents.Editor
{
    ...
    {
        public const string Update_Assets = "Assets/KSwordKit/框架内容/更新框架";
        public const string Update = "KSwordKit/框架内容/更新框架 _%#U";

        public const string ImportChild_Assets = "Assets/KSwordKit/框架内容/导入部件";
        public const string ImportChild = "KSwordKit/框架内容/导入部件 _%#I";
        public const string ImportWindowTitle = "导入部件";
        public const string ImportConfigFileName = "ImportConfig.json";

        public const string DeleteChild_AlreadyImport_Assets = "Assets/KSwordKit/框架内容/删除已导入部件";
        public const string DeleteChild_AlreadyImport = "KSwordKit/框架内容/删除已导入部件 _%#D";
        public const string DeleteImportWindowTitle = "导入部件";

        public const string MakeNew_Assets = "Assets/KSwordKit/框架内容/制作新部件";
        public const string MakeNew = "KSwordKit/框架内容/制作新部件 _%&N";
        public const string MakeNewWindowTitle = "制作新部件";

        public const string About_Assets = "Assets/KSwordKit/框架内容/关于作者";
        public const string AboutUs = "KSwordKit/框架内容/关于作者 _%&M";
